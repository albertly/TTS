...
class OaadDownloader(AudioDownloader):
    ...
    def __init__(self):
        ...
        self.url = 'http://oaadonline.oxfordlearnersdictionaries.com/dictionary/'
        self.url_sound = self.icon_url
        self.extras = dict(Source="Oaad", Variant="US")
    ...
    def download_files(self, word, base, ruby, split):
        ...
        # <img src="/external/images/pron-us.gif" alt="mutilate pronunciation American" title="mutilate pronunciation American" 
        # class="sound" style="cursor: pointer" onclick="playSoundFromFlash('/media/oaad8/us_pron/m/mut/mutil/mutilate__us_2.mp3', this)" valign="top">
