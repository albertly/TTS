...
"""
Download pronunciations from  Cambridge American Dictionary.
"""
...
class CambridgeAmericanDownloader(AudioDownloader):
    """Download audio from Cambridge American Dictionary."""
    def __init__(self):
        AudioDownloader.__init__(self)
        self.file_extension = u'.mp3'
        self.icon_url = 'http://dictionary.cambridge.org/'
        self.url = 'http://dictionary.cambridge.org/dictionary/american-english/'
        self.url_sound = ""
        self.extras = dict(Source="Cambridge", Variant="US")
		
    def download_files(self, word, base, ruby, split):
        """
        Get pronunciations of a word from Cambridge American Dictionary.
